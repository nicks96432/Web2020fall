...
class Grid9x9 extends Component {
	checkConflicted = (conflicts, row_index, col_index) => {
		return (
			conflicts.find(
				(c) => c.row_index === row_index + 0 && c.col_index === col_index + 0
			) !== undefined
		);
	};
			...
			<div className="grid_9x9" style={gridStyle}>
				<div className="row">
					<Grid1x1
						...
						conflicted={this.checkConflicted(
							this.props.conflicts,
							this.props.row_offset + 0,
							this.props.col_offset + 0
						)}
					/>
