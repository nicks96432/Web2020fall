...
import "./Grid.css";
export default class Grid1x1 extends React.Component {
	render() {
		const gridStyle = {
			color:
				(this.props.selectedGrid.row_index === this.props.row_index &&
					this.props.selectedGrid.col_index === this.props.col_index) ||
			...
			backgroundColor:
				...
				this.props.selectedGrid.col_index === this.props.col_index
					...
					: "#FFF",
			borderTop:
				this.props.row_index % 3 === 0
					? "1.5px solid transparent"
					: "1.5px solid #999",
			borderBottom:
				this.props.row_index % 3 === 2
					? "1.5px solid transparent"
					: "1.5px solid #999",
			borderLeft:
				this.props.col_index % 3 === 0
					? "1.5px solid transparent"
					: "1.5px solid #999",
			borderRight:
				this.props.col_index % 3 === 2
					? "1.5px solid transparent"
					: "1.5px solid #999",
		};
		return (
			<div
				...
				style={gridStyle}
				onClick={() =>
					this.props.handle_grid_1x1_click(this.props.row_index, this.props.col_index)
				}
			>
