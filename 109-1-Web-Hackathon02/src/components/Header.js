...
export default function Header(props) {
	...
	const problemList = props.problemList.map((p) => <MenuItem key={p} value={p}>{p}</MenuItem>);
	return (
		<div className={classes.headerHolder}>
			...
			<div className={classes.buttonHolder}>
				...
				<Button onClick={props.resetGame} className={classes.button} variant="contained" size="small">
					Reset Game
				</Button>
			</div>
		</div>
